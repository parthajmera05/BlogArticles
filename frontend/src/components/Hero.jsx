    ...
    <section className="relative bg-black text-white py-20 text-center w-full h-screen flex justify-center items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="mt-6 flex justify-center space-x-4 relative z-10">
          <button className="bg-pink-500 hover:bg-pink-600 text-white font-semibold px-6 py-3 rounded-full text-lg">
            Start Reading
          </button>
          <button className="border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-black font-semibold px-6 py-3 rounded-full text-lg">
            Subscribe
          </button>
        </div>
      </div>
